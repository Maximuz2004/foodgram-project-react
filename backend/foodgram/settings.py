...
COOKING_TIME_ERROR_MESSAGE = f'Время приготовления должно быть не менее {MIN_COOKING_TIME} и больше {MAX_COOKING_TIME}'
AMOUNT_VALUE_ERROR_MESSAGE = f'Количество ингредиента не может быть меньше {MIN_AMOUNT_VALUE} и больше {MAX_AMOUNT_VALUE}'
ROLE_ADMIN = 'admin'
ROLE_USER = 'user'
